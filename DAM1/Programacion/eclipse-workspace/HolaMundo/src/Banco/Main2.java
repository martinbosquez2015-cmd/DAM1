...
public class Main2 {
	...
	public static void main(String[] args) {
		...
		CuentasCorrientes cuenta2= new CuentasCorrientes(c2, 1000, sevilla1, "987654321124");
		CuentasCorrientes cuenta3= new CuentasCorrientes(c2, 10000, sevilla1, "987654321125");
		CuentasCorrientes cuenta4= new CuentasCorrientes(c2, 100000, sevilla1, "987654321126");
		CuentasCorrientes cuenta5= new CuentasCorrientes(c2, c2, 1000000000, sevilla1, "987654321123");
		CuentasCorrientes cuenta6= new CuentasCorrientes(c2, 200000, sevilla1, "987654321127");
		CuentasCorrientes cuenta7= new CuentasCorrientes(c2, 300000, sevilla1, "987654321128");
		ArrayList<CuentasCorrientes> cuentas = new ArrayList(List.of(cuenta1,cuenta2,cuenta3,cuenta4,cuenta5,cuenta6,cuenta7));
		Collections.sort(cuentas);
		for(CuentasCorrientes c: cuentas) {
